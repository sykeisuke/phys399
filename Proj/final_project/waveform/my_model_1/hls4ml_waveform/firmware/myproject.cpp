...
void myproject(
    ...
    #pragma HLS INTERFACE ap_vld port=fc1_input,layer11_out 
    #pragma HLS PIPELINE
    ...
    if (!loaded_weights) {
        ...
        nnet::load_weights_from_txt<model_default_t, 512>(w5, "w5.txt");
        ...
        nnet::load_weights_from_txt<model_default_t, 64>(w11, "w11.txt");
